...
if __package__:
    from .constants import FREQ_DAILY, FREQ_MONTHLY, METRICS_DIR, FAMILY_BASELINE, FAMILY_STATISTICAL, FAMILY_MACHINE_LEARNING, FAMILY_DEEP_LEARNING
...
def calculate_metrics(prediction_df: pd.DataFrame, family: str, frequency: str, use_existing: bool = True) -> pd.DataFrame:
...
if __name__ == "__main__":
    ...
    calculate_metrics(val_base, FAMILY_BASELINE, FREQ_DAILY, use_existing=False)
    calculate_metrics(val_stat, FAMILY_STATISTICAL, FREQ_DAILY, use_existing=False)
    calculate_metrics(val_ml, FAMILY_MACHINE_LEARNING, FREQ_DAILY, use_existing=False)
    calculate_metrics(val_dl, FAMILY_DEEP_LEARNING, FREQ_DAILY, use_existing=False)
    ...
    calculate_metrics(val_m_base, FAMILY_BASELINE, FREQ_MONTHLY, use_existing=False)
    calculate_metrics(val_m_stat, FAMILY_STATISTICAL, FREQ_MONTHLY, use_existing=False)
    calculate_metrics(val_m_ml, FAMILY_MACHINE_LEARNING, FREQ_MONTHLY, use_existing=False)
    calculate_metrics(val_m_dl, FAMILY_DEEP_LEARNING, FREQ_MONTHLY, use_existing=False)